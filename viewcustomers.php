...
<head>
    ...
    <title>Blue Bank | Customers</title>
...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        <!--Navbar-->
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:black; background-color:#59bfff; opacity:1;"> 
            <img  height="90"src="./images/letter-b.png">
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:white;font-family: 'Bodoni MT Black', cursive;font-size:4em;">
                &nbsp;Blue Bank
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                <ul class="navbar-nav ml-auto font-weight-bold"  style="font-size:small; color:purple; "> 
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:black;font-weight:1em;">
                            <div style="padding-right:0px;" >
                                <img height="60"src="./images/home.png">

                            </div>
                            <span style="padding-right:20px;" >&nbsp;&nbsp;H O M E</span>
                        </a> 
                    </li> 
                    <li class="nav-item">
