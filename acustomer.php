            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:black;font-weight:1em;">
                            ...
                            <span style="padding-right:20px;font-size:2" >&nbsp;&nbsp;H O M E </span>
                        </a> 
                    </li> 
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:black;font-weight:1em;">
                            <div style="padding-left:20px;" >
                                <img height="55"src="./images/document.png">
                            </div>
                            R E C O R D S
                        </a> 
                    </li>  
...
<div class="row">
    ...
    <img  height="50" src="./images/arrows.png" alt="" style="display:inline;">&nbsp;
