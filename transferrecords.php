...
<div class="usertable">
    ...
    <h3 class="font-weight-bold"style="text-align:center;color:black;font-family: 'Copperplate Gothic Light', cursive;font-size:2.2em;padding:3%;">T R A N S F E R   -   R E C O R D S</h3>
    <table id="myTable">
          <tr>
            <th>Transfer ID</th>
            <th>Sender</th>
